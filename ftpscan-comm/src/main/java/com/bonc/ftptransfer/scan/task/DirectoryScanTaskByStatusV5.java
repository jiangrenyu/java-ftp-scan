...
public class DirectoryScanTaskByStatusV5 implements Runnable {
	
	private static Logger LOG = LoggerFactory.getLogger(DirectoryScanTaskByStatusV5.class);
	...
	public DirectoryScanTaskByStatusV5(boolean isSFTP, int loginTimeout,int queryBatchSize, List<FtpPath> ftpPathList, JdbcUtils jdbcUtil,
									...
									if(!fileId.equals(oldFileId)){
										...
										try {
											...
											if(!FtpFileStatus.UNDOWNLOAD.equals(oldFileStatus) && !FtpFileStatus.DOWNLOADING.equals(oldFileStatus)){
												...
												//状态为未下载或下载中
												logFileStatus.setStatus(oldFileStatus);
											}
